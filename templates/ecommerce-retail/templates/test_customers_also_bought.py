"""
Test Case: 'Customers Also Bought' Recommendations
Show products frequently purchased together with current item
"""
...
def test_customers_also_bought(token_data: TokenData, project_id: str):
    ...
    try:
        print("=== Testing Customers Also Bought ===")
...
if __name__ == "__main__":
    ...
    project_id = generate_project(
        name="Customers Also Bought Test",
        description="Test project for customers also bought recommendations",
    )
