"""
Test Case: 'New Arrivals' Recently added products matching user preferences
"""
...
def test_new_arrivals_(token_data: TokenData, project_id: str):
    """Test 'New Arrivals'"""
    url = os.getenv("DODO_URL").rstrip("/")
    ...
    sequence_data = {"user_interests": ["technology", "fitness", "outdoor"], "new_categories": ["smart_home", "wearables", "camping_gear"], "launch_period": "last_30_days"}
...
if __name__ == "__main__":
    ...
    project_id = generate_project(
        name="New Arrivals  Test",
        description="Test project for test new arrivals  recommendations",
    )

    # Make recommendations
    test_new_arrivals_(token_data, project_id)
