"""
Test Case: 'Context-aware Search' Adjust results based on context
"""
...
def test_context_aware_search_(token_data: TokenData, project_id: str):
...
if __name__ == "__main__":
    ...
    project_id = generate_project(
        name="Context-aware Search Test",
        description="Test project for context-aware search recommendations",
    )
    ...
    test_context_aware_search_(token_data, project_id)
