"""
Test Case: 'Complete Your Collection' Products from same category or collection
"""
...
def test_complete_collection_(token_data: TokenData, project_id: str):
    """Test 'Complete Your Collection'"""
    url = os.getenv("DODO_URL").rstrip("/")
    ...
    try:
        print("=== Testing Complete Your Collection ===")
...
if __name__ == "__main__":
    ...
    project_id = generate_project(
        name="Complete Collection Test",
        description="Test project for complete collection recommendations",
    )
    ...
    test_complete_collection_(token_data, project_id)
