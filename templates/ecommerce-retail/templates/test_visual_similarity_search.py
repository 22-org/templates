"""
Test Case: 'Visual Similarity Search' Find visually similar products
"""
...
def test_visual_similarity_search_(token_data: TokenData, project_id: str):
    ...
    sequence_data = {"viewed_product_image": "red_running_shoes.jpg", "visual_features": ["red_color", "athletic_style", "mesh_material"], "similar_attributes": ["comfort", "breathability", "durability"]}
    
    template = "Find products visually similar to {viewed_product_image} with features like {visual_features} and attributes {similar_attributes}"  # noqa
...
if __name__ == "__main__":
    ...
    project_id = generate_project(
        ...
        description="Test project for test visual similarity search  recommendations",
    )
