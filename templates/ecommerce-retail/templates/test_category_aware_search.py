"""
Test Case: 'Category-aware Search' Prioritize results from preferred categories
"""
...
def test_category_aware_search_(token_data: TokenData, project_id: str):
    ...
    try:
        print("=== Testing Category-aware Search ===")
...
if __name__ == "__main__":
    ...
    project_id = generate_project(
        name="Category-aware Search Test",
        description="Test project for category-aware search recommendations",
    )
    ...
    test_category_aware_search_(token_data, project_id)
