"""
Test Case: Demographic Targeting
Ads based on user demographics and firmographics
"""
...
def test_demographic_targeting(token_data: TokenData, project_id: str):
    ...
    template = (
        "Target ads for {age_group} age group, {gender} gender in {location} "
        "areas with {income_level} income, focusing on {industry} industry"
    )

    payload = {"sequence_data": sequence_data, "template": template}

    try:
        print("=== Testing Demographic Targeting ===")
...
if __name__ == "__main__":
    ...
    project_id = generate_project(
        name="Demographic Targeting Test",
        description="Test project for demographic-based advertisement targeting",
    )

    # Make recommendations
    test_demographic_targeting(token_data, project_id)
